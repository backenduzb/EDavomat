...
from bot.database.students import get_all_stundets_by_admin, get_all_stundets_by_teacher
...
async def get_students_by_techer_buttons(tg_id: int) -> ReplyKeyboardMarkup:
    students = await get_all_stundets_by_teacher(tg_id)
